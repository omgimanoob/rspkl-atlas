    ...
    if (wantKimai) {
      parts.push(
        `SELECT 'kimai' AS origin,
                ...
                p.id AS kimaiId,
                NULL AS atlasId,
                CONVERT(p.name USING utf8mb4) COLLATE utf8mb4_unicode_ci AS displayName,
                o.status_id AS statusId,
                CONVERT(s.name USING utf8mb4) COLLATE utf8mb4_unicode_ci AS statusName,
                o.money_collected AS moneyCollected,
                0 AS isProspective,
                CONVERT(o.notes USING utf8mb4) COLLATE utf8mb4_unicode_ci AS notes,
                CONVERT(p.comment USING utf8mb4) COLLATE utf8mb4_unicode_ci AS comment,
    ...
    if (wantAtlas) {
      parts.push(
        `SELECT 'atlas' AS origin,
                ...
                NULL AS kimaiId,
                a.id AS atlasId,
                CONVERT(a.name USING utf8mb4) COLLATE utf8mb4_unicode_ci AS displayName,
                a.status_id AS statusId,
                CONVERT(s.name USING utf8mb4) COLLATE utf8mb4_unicode_ci AS statusName,
                NULL AS moneyCollected,
                1 AS isProspective,
                CONVERT(a.notes USING utf8mb4) COLLATE utf8mb4_unicode_ci AS notes,
